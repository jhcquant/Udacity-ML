...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = math.fabs(math.exp(-(self.alpha*self.trial_num)))
    ...
    def get_maxQ(self, state):
        ...
        if state in self.Q:
            actions_ = self.Q[state]
            action_list = list(actions_.values())
            maxQ = max(action_list)
        ...
        if not self.learning:
            ...
            if self.epsilon > random.random():
                ...
                for actn in self.Q[state]:
                    if maxQ == self.Q[state][actn]:
                        valid_actions.append(actn)
